                    ...
                    <View style={styles.section}>
                        ...
                        <View style={[styles.inputContainer,{justifyContent:"flex-start"}]}>
                            ...
                            <View style={[styles.radioContainer,{alignContent:"center"}]}>
                                <RadioButton color='rgba(114, 206, 99, 1)' value="Yes" status={isSingleFounder ? 'checked' : 'unchecked'} onPress={() => setIsSingleFounder(true)}/>
                                <Text style={{color: '#FFF', fontSize: 16,alignSelf:"center"}}> Yes</Text>
                                <RadioButton value="No" status={!isSingleFounder ? 'checked' : 'unchecked'} onPress={() => setIsSingleFounder(false)} color='rgba(114, 206, 99, 1)'/>
                        ...
                        {!isSingleFounder && (
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <View style={{flex:1,paddingLeft:15}}> 
                                    ...
                                    <Picker selectedValue={coFounderGender} onValueChange={(itemValue) => setCoFounderGender(itemValue)} style={styles.picker}>
                                        <Picker.Item label="Male" value="Male" />
                                        <Picker.Item label="Female" value="Female" />
                                    </Picker>
                                </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <View style={{flex:1,paddingLeft:15}}> 
                                ...
                                <Picker selectedValue={businessSector} onValueChange={(itemValue) => setBusinessSector(itemValue)} style={styles.picker}>
                        ...
                        <View style={styles.inputContainer}>
                            <View style={{flex:1}}>
                                ...
                                <Picker selectedValue={stage} onValueChange={(itemValue) => setStage(itemValue)} style={styles.picker}>
                            ...
                            <View style={{flex:1,marginLeft:15}}>
                                ...
                                <DatePicker modal mode="date" open={open} date={date} onConfirm={(selectedDate) => { setOpen(false);  setDate(selectedDate); }} onCancel={() => setOpen(false)} />
                            </View>
                        </View>
