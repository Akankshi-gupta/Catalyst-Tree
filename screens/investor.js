...
export default function Investor({navigation}) {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Header buttonText={"Signup"} description={"Invest smarter with detailed startup insights, risk scores, and seamless deal-making tools."} title={"Discover the Next Big Opportunity"} imageSource={require("../assets/images/investor1.png")} onButtonPress={()=>navigation.navigate("VerifyEmail")}></Header>
