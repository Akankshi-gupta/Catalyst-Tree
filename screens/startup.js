...
export default function Startup({navigation}) {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <ExpoLinearGradient colors={["rgba(44, 165, 96, 0.1)", "rgba(44, 165, 96, 0.1)", "rgba(44, 165, 96, 0.1)"]} style={{ position: "absolute", top: 0, right: 0, zIndex: -1, height: '13%', width: '32%', borderBottomLeftRadius: 12}} />
