...
export default function Startup({navigation}) {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Header buttonText={"Signup"} description={"Whether you're raising debt, equity, or exploring M&A and acceleration opportunities, we've got you covered."} title={"Fuel Your Growth with the Right Funding Partners"} imageSource={require("../assets/images/startup.png")}  onButtonPress={()=> navigation.navigate("VerifyEmail")}></Header>
